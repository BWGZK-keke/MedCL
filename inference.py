...
def infer(model, criterion, dataloader_dict, device):
    ...
    test_folder = "/data/zhangke/datasets/scribble/val/images/"
    label_folder = "/data/zhangke/datasets/scribble/val/labels/"
    output_folder = "/data/zhangke/datasets/scribble/output_UNet_wpce/"
